...
description: Next.js로 만든 블로그에 SEO를 적용해보자!
date: 2023-06-14
tags: [next.js, next.js블로그, next.js13, seo, metadata]
---
...
[Next.js 공식문서 - robots.txt](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/robots)는 다른 Next 블로그들과 달리 /app 폴더에 robots.txt 파일을 생성하라고 한다. sitemap.ts와 통일성을 주기 위해 robots.ts로 생성했다.
