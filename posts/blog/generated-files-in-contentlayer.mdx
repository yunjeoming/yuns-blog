---
title: contentlayer.config.ts에서 여러 폴더 생성할 경우 경로 변경하는 방법
description: /posts 폴더에 여러 하위 폴더 생성 후 각각 mdx 파일을 추가할 때 contentlayer.config.ts를 어떻게 설정해야할까?
date: 2023-06-13
tags: [contentlayer, nextjs, nextjs블로그, contentlayer.config.ts]
---
...
근데 게시글을 보여줄 각 탭이 blog, memo, error 3개였고 추후에 다른 것이 추가되거나 삭제될 수 있기에 경로를 수정 해야했다.
